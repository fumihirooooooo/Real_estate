...
from Models.RoomInfoModel import RoomInfoModel

#部屋情報を取得する動作クラスとして定義
class GetRoomInfo:
    def __init__(self, roomstag: str, room_infotag: str, management_feetag: str):
        self.roomstag = roomstag
        self.room_infotag = room_infotag
        self.management_feetag = management_feetag
    ...
    def get_room_info(self, listing_soup: BeautifulSoup) -> List[RoomInfoModel]:
        ...
        if self.roomstag and self.room_infotag: 
            ...
            #管理費を取得
            management_fee_element = listing_soup.select_one(self.management_feetag)
